# 💬 MERN – Real-Time Messenger Platform

This GitHub code includes only the core real-time messenger platform. This include **AI-powered conversations** (like Meta AI in Messenger) named as the **Whop AI**.
